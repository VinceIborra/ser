...
namespace Ser.Ea.Addin.SerAws {
    class WorkItemProcessorImpl : WorkItemProcessor {

        public Queue<WorkItem> WorkItemQueue { set; get; } = null;
        public WorkItemFactory WorkItemFactory { set; get; } = null;

        public AwsRepository AwsRepository { set; get; } = null;
        public AwsModeller AwsModeller { set; get; } = null;
        ...
        public void ProcessQueryAllSubnetsWorkItem(QueryAllSubnetsWorkItemImpl workItem) {
        ...
        public void ProcessQueryAllNetworkAclsWorkItem(QueryAllNetworkAclsWorkItemImpl workItem) {
        ...
        public void ProcessCreateVpcModelWorkItem(CreateVpcModelWorkItemImpl workItem) {
            this.AwsModeller.createModel(workItem.Pkg, workItem.Vpc, workItem.EnableDnsSupport, workItem.EnableDnsHostnames);
        }
        public void ProcessCreateSubnetModelWorkItem(CreateSubnetModelWorkItemImpl workItem) {
            this.AwsModeller.createModel(workItem.Pkg, workItem.Subnet);
        }
        public void ProcessCreateRouteTableModelWorkItem(CreateRouteTableModelWorkItemImpl workItem) {
            this.AwsModeller.createModel(workItem.Pkg, workItem.RouteTable);
        }
        public void ProcessCreateInternetGatewayModelWorkItem(CreateInternetGatewayModelWorkItemImpl workItem) {
            this.AwsModeller.createModel(workItem.Pkg, workItem.InternetGateway);
        }
        public void ProcessCreateSecurityGroupModelWorkItem(CreateSecurityGroupModelWorkItemImpl workItem) {
            this.AwsModeller.createModel(workItem.Pkg, workItem.SecurityGroup);
        }
        public void ProcessCreateNetworkAclModelWorkItem(CreateNetworkAclModelWorkItemImpl workItem) {
            this.AwsModeller.createModel(workItem.Pkg, workItem.NetworkAcl);
        }
        public void ProcessCreateDbInstanceModelWorkItem(CreateDbInstanceModelWorkItemImpl workItem) {
